...
export const playGroundHeight = window.innerHeight-20;
export const playGroundWidth = window.innerWidth-20;
export const frameNumber = 30;
export const spritePath = '../assets/img/sprites.png';
export const playerCarSpeed = 4;
